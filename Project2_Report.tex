...
\subsection*{Calculation 10: The Fourier transform for the ideal filter}
...
have content about \(F = 22\)kHz. The ideal low pass filter is a rect function, centered at \(F = 0\)Hz, with a width of \(2F_{LPF}\) (Low-Pass Filter), where \(F_{LPF}\) is the cutoff
